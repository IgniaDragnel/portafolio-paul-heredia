...
const SOCIALS: Social[] = [
  ...
  { label: 'Correo', href: CONTACT.emailCompose, d: 'M1.5 8.67v8.58a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V8.67l-8.928 5.493a3 3 0 0 1-3.144 0L1.5 8.67ZM22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714 5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908Z' },
...
export default function Hero() {
  ...
  const [photoSrc, setPhotoSrc] = useState<string>(CONTACT.photo);
  ...
  const copyEmail = (_e: MouseEvent<HTMLAnchorElement>) => {
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-6xl items-center gap-14 px-4 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="text-center lg:text-left">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4 lg:justify-start">
            ...
            <a
              href={CONTACT.cv}
              download="CV-Paul_Heredia.pdf"
              className="inline-flex items-center gap-2 rounded-lg border border-[var(--success)]/40 px-6 py-3 font-semibold text-[var(--success)] transition-all hover:-translate-y-0.5 hover:border-[var(--success)] hover:bg-[rgba(52,211,153,0.1)]"
            >
